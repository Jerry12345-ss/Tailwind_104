<template>
    <header class="bg-white p-4">
        <div class="flex header-container items-center">
            <div class="flex items-center lg:flex-1">
                <div class="hamburger-menu min-w-6 h-6 flex items-center cursor-pointer lg:hidden" @click="handleMenu">
                    <span class="menu-item w-full bg-gray-500 inline-block relative"></span>
                </div>
        ...
        <div v-show="isMobileContent" class="mobile-content" :class="{ open : isMobileContent }">
            123 3345
        </div>
    </header>
</template>
